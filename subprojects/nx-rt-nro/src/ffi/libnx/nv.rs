...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_nro__libnx_nv_exit() {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_nro__libnx_nv_open(
    fd: *mut u32,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_nro__libnx_nv_ioctl(
    fd: u32,
    request: u32,
    argp: *mut c_void,
) -> u32 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_nro__libnx_nv_ioctl2(
    fd: u32,
    request: u32,
    argp: *mut c_void,
    inbuf: *const c_void,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_nro__libnx_nv_ioctl3(
    fd: u32,
    request: u32,
    argp: *mut c_void,
    outbuf: *mut c_void,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_nro__libnx_nv_close(fd: u32) -> u32 {
    let Some(service) = crate::services::nv::get_service() else {
        return GENERIC_ERROR;
    };
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_nro__libnx_nv_query_event(
    fd: u32,
    event_id: u32,
    event_out: *mut u32,
) -> u32 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_nro__libnx_nv_convert_error(rc: i32) -> u32 {
    if rc == 0 {
        return 0;
    }
