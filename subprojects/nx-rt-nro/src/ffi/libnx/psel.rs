...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_nro__libnx_psel_ui_create(ui: *mut UiSettings, mode: u32) -> u32 {
...
/// `ui` must point to a writable `PselUiSettings`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_nro__libnx_psel_ui_add_user(
    ui: *mut UiSettings,
    user: AccountUid,
) {
    // SAFETY: The caller upholds this function's `# Safety` contract, so `ui` is
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_nro__libnx_psel_ui_show(
    ui: *mut UiSettings,
    out_user: *mut AccountUid,
) -> u32 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_nro__libnx_psel_show_user_selector_for_system(
    out_user: *mut AccountUid,
...
/// Every pointer must point to a valid value of its type.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_nro__libnx_psel_show_user_selector_for_launcher(
    out_user: *mut AccountUid,
    settings: *const UserSelectionSettings,
    application_id: u64,
) -> u32 {
...
/// Every pointer must point to a valid value of its type.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_nro__libnx_psel_show_user_selector(
    out_user: *mut AccountUid,
    settings: *const UserSelectionSettings,
) -> u32 {
    // SAFETY: The caller upholds this function's `# Safety` contract, so each
...
/// leaves the applet.
#[unsafe(no_mangle)]
pub extern "C" fn __nx_rt_nro__libnx_psel_show_user_creator() -> u32 {
...
/// leaves the applet.
#[unsafe(no_mangle)]
pub extern "C" fn __nx_rt_nro__libnx_psel_show_user_icon_editor(user: AccountUid) -> u32 {
...
#[unsafe(no_mangle)]
pub extern "C" fn __nx_rt_nro__libnx_psel_show_user_nickname_editor(user: AccountUid) -> u32 {
...
#[unsafe(no_mangle)]
pub extern "C" fn __nx_rt_nro__libnx_psel_show_user_creator_for_starter() -> u32 {
...
#[unsafe(no_mangle)]
pub extern "C" fn __nx_rt_nro__libnx_psel_show_nintendo_account_nnid_linker(
    user: AccountUid,
) -> u32 {
...
/// until the user leaves the applet.
#[unsafe(no_mangle)]
pub extern "C" fn __nx_rt_nro__libnx_psel_show_user_qualification_promoter(
    user: AccountUid,
) -> u32 {
