...
//!   [`__nx_rt_nro__libnx_hid_la_show_controller_support_for_system`], which
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_nro__libnx_hid_la_create_controller_support_arg(
...
/// the call.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_nro__libnx_hid_la_set_explain_text(
    arg: *mut ControllerSupportArg,
    text: *const c_char,
    id: u32,
) -> u32 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_nro__libnx_hid_la_show_controller_support(
...
#[unsafe(no_mangle)]
pub extern "C" fn __nx_rt_nro__libnx_hid_la_show_controller_strap_guide() -> u32 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_nro__libnx_hid_la_show_controller_firmware_update(
...
/// [`__nx_rt_nro__libnx_hid_la_show_controller_support`] it always presents it,
/// and with `flag` set it presents it as qlaunch does.
///
/// # Safety
///
/// `result_info` must be null or point to a writable
...
/// `HidLaControllerSupportArg`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_nro__libnx_hid_la_show_controller_support_for_system(
    result_info: *mut ControllerSupportResultInfo,
    arg: *const ControllerSupportArg,
    flag: bool,
) -> u32 {
...
/// `arg` must point to a readable `HidLaControllerFirmwareUpdateArg`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_nro__libnx_hid_la_show_controller_firmware_update_for_system(
    arg: *const ControllerFirmwareUpdateArg,
    caller: u32,
) -> u32 {
    if hos_version::get() < HosVersion::new(3, 0, 0) {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_nro__libnx_hid_la_show_controller_key_remapping_for_system(
