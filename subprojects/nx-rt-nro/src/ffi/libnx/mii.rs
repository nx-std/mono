...
/// leaves the applet.
#[unsafe(no_mangle)]
pub extern "C" fn __nx_rt_nro__libnx_mii_la_show_mii_edit(special_key_code_raw: u32) -> u32 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_nro__libnx_mii_la_append_mii(
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_nro__libnx_mii_la_append_mii_image(
    special_key_code_raw: u32,
...
/// `count` is zero or negative, and `index` must point to a writable `s32`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_nro__libnx_mii_la_update_mii_image(
    special_key_code_raw: u32,
    valid_uuid_array: *const Uuid,
    count: i32,
    used_uuid: Uuid,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_nro__libnx_mii_la_create_mii(
    special_key_code_raw: u32,
    out_char: *mut MiiCharInfo,
) -> u32 {
...
/// writable one.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_nro__libnx_mii_la_edit_mii(
    special_key_code_raw: u32,
