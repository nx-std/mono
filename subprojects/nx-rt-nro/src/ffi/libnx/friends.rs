...
#[unsafe(no_mangle)]
pub extern "C" fn __nx_rt_nro__libnx_friends_la_show_friend_list(uid: AccountUid) -> u32 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_nro__libnx_friends_la_show_user_detail_info(
    uid: AccountUid,
...
/// `FriendsInAppScreenName`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_nro__libnx_friends_la_start_sending_friend_request(
    uid: AccountUid,
    id: AccountNetworkServiceAccountId,
    first_in_app_screen_name: *const InAppScreenName,
    second_in_app_screen_name: *const InAppScreenName,
...
#[unsafe(no_mangle)]
pub extern "C" fn __nx_rt_nro__libnx_friends_la_show_methods_of_sending_friend_request(
    uid: AccountUid,
) -> u32 {
...
/// until the user leaves the applet.
#[unsafe(no_mangle)]
pub extern "C" fn __nx_rt_nro__libnx_friends_la_start_faced_friend_request(uid: AccountUid) -> u32 {
...
#[unsafe(no_mangle)]
pub extern "C" fn __nx_rt_nro__libnx_friends_la_show_received_friend_request_list(
    uid: AccountUid,
) -> u32 {
...
/// until the user leaves the applet.
#[unsafe(no_mangle)]
pub extern "C" fn __nx_rt_nro__libnx_friends_la_show_blocked_user_list(uid: AccountUid) -> u32 {
...
#[unsafe(no_mangle)]
pub extern "C" fn __nx_rt_nro__libnx_friends_la_show_my_profile(uid: AccountUid) -> u32 {
...
/// Blocks until the user leaves the applet.
#[unsafe(no_mangle)]
pub extern "C" fn __nx_rt_nro__libnx_friends_la_show_my_profile_for_home_menu(
    uid: AccountUid,
) -> u32 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_nro__libnx_friends_la_start_friend_invitation(
    uid: AccountUid,
    id_count: i32,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_nro__libnx_friends_la_start_sending_friend_invitation(
    uid: AccountUid,
...
#[unsafe(no_mangle)]
pub extern "C" fn __nx_rt_nro__libnx_friends_la_show_received_invitation_detail(
    uid: AccountUid,
