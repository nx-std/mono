...
/// Address space reservation type (see \ref __nx_virtmem_add_reservation)
 ...
 * @note The virtual memory manager mutex must be held during the find-and-map process (see \ref __nx_virtmem_lock and \ref __nx_virtmem_unlock).
 */
 ...
 * @note The virtual memory manager mutex must be held during the find-and-reserve process (see \ref __nx_virtmem_lock and \ref __nx_virtmem_unlock).
 */
 ...
 * @note The virtual memory manager mutex must be held before calling this function (see \ref __nx_virtmem_lock and \ref __nx_virtmem_unlock).
 */
