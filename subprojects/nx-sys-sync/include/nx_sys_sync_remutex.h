 ...
 */
void __nx_sys_sync_remutex_init(ReentrantMutex* m);

/**
 * @brief Locks a reentrant mutex.
 * @param m ReentrantMutex object.
 */
void __nx_sys_sync_remutex_lock(ReentrantMutex* m);
 ...
 */
bool __nx_sys_sync_remutex_try_lock(ReentrantMutex* m);

/**
 * @brief Unlocks a reentrant mutex.
 * @param m ReentrantMutex object.
 */
void __nx_sys_sync_remutex_unlock(ReentrantMutex* m); 
