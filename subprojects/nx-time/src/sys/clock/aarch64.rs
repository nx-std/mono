...
pub const TIMER_FREQ: Hz = Hz::from_raw_unchecked(19_200_000);
...
#[cfg(feature = "ffi")]
pub const NSEC_PER_TICK: u64 = cpu_ticks_to_ns(Ticks::from_raw_unchecked(1));
...
pub const fn ns_to_cpu_ticks(ns: u64) -> Ticks {
    ...
    Ticks::from_raw_unchecked((ns * TICKS_PER_RATIO) / NSEC_PER_RATIO)
}
...
pub fn gettime() -> Result<Timespec, i32> {
    ...
    let subsec_ticks = Ticks::from_raw_unchecked(now % TIMER_FREQ.to_raw());
