...
/// Sets the HOS version.
///
/// This is called by the entry crate during environment initialization (with
/// bit 31 set when Atmosphere is detected) and from the C-FFI surface.
pub fn set(version: u32) {
