...
impl SslService {
    ...
    pub fn create_context(
        ...
        // pool slot.
        let object = unsafe { guard.domain().open_object_raw(raw_object_id) }
...
// ---------------------------------------------------------------------------
// SslContext (ISslContext sub-object)
// ---------------------------------------------------------------------------
...
impl SslContext<'_> {
    ...
    pub fn create_connection_for_system(&self) -> Result<SslConnection<'_>, CreateConnectionError> {
        let raw_object_id = cmif::create_connection_for_system(&self.object)?;
        let guard = self.pool.acquire();
    ...
    pub fn import_server_pki(
        ...
        cmif::import_server_pki(&self.object, cert_data, format as u32)
    }
    ...
    pub fn register_internal_pki(&self, pki: InternalPki) -> Result<u64, DispatchError> {
        cmif::register_internal_pki(&self.object, pki as u32)
    }
    ...
    pub fn import_client_cert_key_pki(
        ...
        cmif::import_client_cert_key_pki(&self.object, cert, key, format as u32)
    }
...
// ---------------------------------------------------------------------------
// SslConnection (ISslConnection sub-object)
// ---------------------------------------------------------------------------
...
impl SslConnection<'_> {
    ...
    pub fn set_verify_option(&self, options: VerifyOption) -> Result<(), DispatchError> {
        cmif::set_verify_option(&self.object, options.bits())
    }

    /// Sets the I/O mode.
    pub fn set_io_mode(&self, mode: IoMode) -> Result<(), DispatchError> {
        cmif::set_io_mode(&self.object, mode as u32)
    }
    ...
    pub fn poll(&self, in_pollevent: PollEvent, timeout: u32) -> Result<PollEvent, DispatchError> {
        cmif::poll(&self.object, in_pollevent.bits(), timeout).map(PollEvent::from_bits_retain)
    }
    ...
    pub fn set_session_cache_mode(&self, mode: SessionCacheMode) -> Result<(), DispatchError> {
        cmif::set_session_cache_mode(&self.object, mode as u32)
    }
    ...
    pub fn set_renegotiation_mode(&self, mode: RenegotiationMode) -> Result<(), DispatchError> {
        cmif::set_renegotiation_mode(&self.object, mode as u32)
    }
    ...
    pub fn set_private_option_legacy(
        ...
        cmif::set_private_option_legacy(&self.object, option as u32, value)
    }
    ...
    pub fn set_private_option(
        ...
        cmif::set_private_option(&self.object, option as u32, value)
    }
