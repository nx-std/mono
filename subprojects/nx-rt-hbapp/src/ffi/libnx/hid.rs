...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_hid_initialize() -> u32 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_hid_exit() {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_hid_get_sharedmem_addr() -> *const c_void {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_hid_initialize_npad() {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_hid_set_supported_npad_style_set(
    style_set: u32,
) -> u32 {
    match crate::services::hid::get_service() {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_hid_set_supported_npad_id_type(
    ids: *const u32,
    count: usize,
) -> u32 {
    if ids.is_null() {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_hid_initialize_touch_screen() {
    if let Some(service) = crate::services::hid::get_service() {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_hid_initialize_mouse() {
    if let Some(service) = crate::services::hid::get_service() {
        // A refusal leaves that one input source inactive: the process
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_hid_initialize_keyboard() {
    if let Some(service) = crate::services::hid::get_service() {
        // A refusal leaves that one input source inactive: the process
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_hid_initialize_gesture() {
    if let Some(service) = crate::services::hid::get_service() {
        // A refusal leaves that one input source inactive: the process
