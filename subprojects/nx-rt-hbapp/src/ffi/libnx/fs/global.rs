...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_get_and_clear_error_info(
    _out: *mut c_void,
) -> u32 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_get_and_clear_memory_report_info(
    _out: *mut c_void,
) -> u32 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_get_content_storage_info_index(
    _out: *mut i32,
) -> u32 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_get_global_access_log_mode(
    _out_mode: *mut u32,
) -> u32 {
...
#[unsafe(no_mangle)]
pub extern "C" fn __nx_rt_hbapp__libnx_fs_set_global_access_log_mode(_mode: u32) -> u32 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_get_program_id(
    _out: *mut u64,
    _path: *const c_char,
    _attr: u8,
) -> u32 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_get_program_index_for_access_log(
...
/// writable `FsRightsId`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_get_rights_id_by_path(
    _path: *const c_char,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_get_rights_id_and_key_generation_by_path(
    _path: *const c_char,
    _attr: u8,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_is_ex_fat_supported(_out: *mut bool) -> u32 {
...
/// `out` must point to a writable `bool`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_is_signed_system_partition_on_sd_card_valid(
    _out: *mut bool,
) -> u32 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_output_access_log_to_sd_card(
    _log: *const c_char,
    _size: usize,
) -> u32 {
