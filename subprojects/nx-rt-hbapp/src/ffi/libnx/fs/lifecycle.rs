...
/// Backing storage for [`__nx_rt_hbapp__libnx_fs_get_service_session`], which
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_initialize() -> u32 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_exit() {
    fs::exit();
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_get_service_session() -> *mut Service {
...
/// is ignored.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_set_priority(priority: u32) {
