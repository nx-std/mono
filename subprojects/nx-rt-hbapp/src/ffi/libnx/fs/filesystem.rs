...
/// string.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_open_bis_file_system(
    _out: *mut Service,
    _partition_id: u32,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_open_content_storage_file_system(
    _out: *mut Service,
...
/// `out` must point to a writable `Service`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_open_custom_storage_file_system(
    _out: *mut Service,
...
/// `out` must point to a writable `Service`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_open_data_file_system_by_current_process(
    _out: *mut Service,
) -> u32 {
...
/// `out` must point to a writable `Service`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_open_data_file_system_by_program_id(
    _out: *mut Service,
    _program_id: u64,
) -> u32 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_open_file_system(
    _out: *mut Service,
    _fs_type: u32,
...
/// NUL-terminated string.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_open_file_system_with_id(
    _out: *mut Service,
    _id: u64,
    _fs_type: u32,
    _content_path: *const c_char,
...
/// `out` must point to a writable `Service`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_open_file_system_with_patch(
    _out: *mut Service,
    _id: u64,
    _fs_type: u32,
) -> u32 {
...
/// `FsGameCardHandle`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_open_game_card_file_system(
    _out: *mut Service,
...
/// string.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_open_host_file_system(
    _out: *mut Service,
    _path: *const c_char,
) -> u32 {
...
/// string.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_open_host_file_system_with_option(
    _out: *mut Service,
    _path: *const c_char,
    _flags: u32,
) -> u32 {
...
/// `out` must point to a writable `Service`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_open_image_directory_file_system(
    _out: *mut Service,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_open_sd_card_file_system(
    out: *mut Service,
) -> u32 {
