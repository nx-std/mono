...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_device_operator_is_sd_card_inserted(
    _d: *mut Service,
    _out: *mut bool,
) -> u32 {
...
/// `d` must point to a `Service` this module handed out.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_device_operator_get_sd_card_speed_mode(
    _d: *mut Service,
    _out: *mut i64,
) -> u32 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_device_operator_get_sd_card_cid(
    _d: *mut Service,
    _dst: *mut c_void,
    _dst_size: usize,
    _size: i64,
...
/// `d` must point to a `Service` this module handed out.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_device_operator_get_sd_card_user_area_size(
    _d: *mut Service,
    _out: *mut i64,
) -> u32 {
...
/// `d` must point to a `Service` this module handed out.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_device_operator_get_sd_card_protected_area_size(
    _d: *mut Service,
    _out: *mut i64,
) -> u32 {
...
/// `dst_size` writable bytes.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_device_operator_get_and_clear_sd_card_error_info(
    _d: *mut Service,
    _out: *mut c_void,
...
/// `dst_size` writable bytes.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_device_operator_get_mmc_cid(
    _d: *mut Service,
    _dst: *mut c_void,
    _dst_size: usize,
    _size: i64,
...
/// `d` must point to a `Service` this module handed out.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_device_operator_get_mmc_speed_mode(
    _d: *mut Service,
    _out: *mut i64,
) -> u32 {
...
/// `d` must point to a `Service` this module handed out.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_device_operator_get_mmc_patrol_count(
    _d: *mut Service,
    _out: *mut u32,
) -> u32 {
...
/// `dst_size` writable bytes.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_device_operator_get_mmc_extended_csd(
    _d: *mut Service,
    _dst: *mut c_void,
    _dst_size: usize,
    _size: i64,
...
/// `dst_size` writable bytes.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_device_operator_get_and_clear_mmc_error_info(
    _d: *mut Service,
    _out: *mut c_void,
    _out_log_size: *mut i64,
    _dst: *mut c_void,
...
/// `d` must point to a `Service` this module handed out.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_device_operator_is_game_card_inserted(
    _d: *mut Service,
    _out: *mut bool,
) -> u32 {
...
/// `d` must point to a `Service` this module handed out.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_device_operator_get_game_card_handle(
    _d: *mut Service,
    _out: *mut c_void,
) -> u32 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_device_operator_get_game_card_attribute(
    _d: *mut Service,
...
/// `dst_size` writable bytes.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_device_operator_get_game_card_device_id(
    _d: *mut Service,
    _dst: *mut c_void,
    _dst_size: usize,
    _size: i64,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_device_operator_get_game_card_device_certificate(
    _d: *mut Service,
    _handle: *const c_void,
    _dst: *mut c_void,
    _dst_size: usize,
...
/// `dst_size` writable bytes.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_device_operator_get_game_card_id_set(
    _d: *mut Service,
    _dst: *mut c_void,
    _dst_size: usize,
    _size: i64,
...
/// `d` must point to a `Service` this module handed out.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_device_operator_get_game_card_error_report_info(
    _d: *mut Service,
    _out: *mut c_void,
) -> u32 {
...
/// readable `FsGameCardHandle`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_device_operator_get_game_card_update_partition_info(
    _d: *mut Service,
    _handle: *const c_void,
    _out: *mut c_void,
) -> u32 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_device_operator_challenge_card_existence(
    _d: *mut Service,
    _handle: *const c_void,
    _dst: *mut c_void,
    _dst_size: usize,
...
/// twice.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_device_operator_close(_d: *mut Service) {
