...
/// writable.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_file_read(
    file: *const Service,
    offset: i64,
    buf: *mut u8,
    read_size: u64,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_file_write(
    file: *const Service,
    offset: i64,
    buf: *const u8,
    write_size: u64,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_file_flush(file: *const Service) -> u32 {
    // SAFETY: the caller guarantees a readable `Service`.
...
/// `file` must be null or point to a `Service` this module handed out.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_file_set_size(
    file: *const Service,
    size: i64,
) -> u32 {
    // SAFETY: the caller guarantees a readable `Service`.
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_file_get_size(
    file: *const Service,
    out: *mut i64,
) -> u32 {
    if out.is_null() {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_file_close(file: *mut Service) {
    // SAFETY: the caller guarantees a readable `Service`.
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_file_operate_range(
    _f: *mut Service,
    _op_id: u32,
    _off: i64,
    _len: i64,
