...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_open_save_data_info_reader(
    out: *mut Service,
...
/// reader a `fsSaveDataInfoReaderClose`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_open_save_data_info_reader_with_filter(
    out: *mut Service,
    save_data_space_id: i32,
...
/// writable.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_save_data_info_reader_read(
    s: *mut Service,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_save_data_info_reader_close(s: *mut Service) {
    // SAFETY: the caller guarantees a readable `Service`.
    let Some(object_id) = (unsafe { object_id_of(s) }) else {
        return;
    };
