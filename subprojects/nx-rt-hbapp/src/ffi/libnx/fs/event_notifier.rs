...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_open_sd_card_detection_event_notifier(
    _out: *mut Service,
) -> u32 {
...
/// writable `Event`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_event_notifier_get_event_handle(
    _e: *mut Service,
    _out: *mut c_void,
    _autoclear: bool,
) -> u32 {
...
/// twice.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_fs_event_notifier_close(_e: *mut Service) {
