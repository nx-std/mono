...
//! and lives in [`nx_rt_core::ffi::libnx::applet`]; the `rt_hbapp_libnx_service_applet.ld`
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_applet_initialize() -> u32 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_applet_get_applet_type() -> i32 {
