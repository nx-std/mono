...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_vi_initialize(service_type: i32) -> u32 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_vi_exit() {
    let was_initialized = vi::is_initialized();
    vi::exit();
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_vi_get_session_application_display() -> *mut Service {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_vi_get_session_binder_relay() -> *mut Service {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_vi_get_session_system_display() -> *mut Service {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_vi_get_session_manager_display() -> *mut Service {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_vi_get_session_binder_indirect() -> *mut Service {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_vi_open_display(
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_vi_close_display(display: *mut ViDisplay) -> u32 {
    if display.is_null() {
        return GENERIC_ERROR;
    }
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_vi_get_display_resolution(
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_vi_get_display_logical_resolution(
    display: *const ViDisplay,
    width: *mut i32,
    height: *mut i32,
) -> u32 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_vi_set_display_magnification(
    display: *const ViDisplay,
    x: i32,
    y: i32,
    width: i32,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_vi_get_display_vsync_event(
    display: *const ViDisplay,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_vi_set_display_power_state(
    display: *const ViDisplay,
    power_state: u32,
) -> u32 {
    if display.is_null() {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_vi_set_display_alpha(
    display: *const ViDisplay,
    alpha: f32,
) -> u32 {
    if display.is_null() {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_vi_get_z_order_count_min(
    display: *const ViDisplay,
    z: *mut i32,
) -> u32 {
    if display.is_null() {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_vi_get_z_order_count_max(
    display: *const ViDisplay,
    z: *mut i32,
) -> u32 {
    if display.is_null() {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_vi_create_layer(
    display: *const ViDisplay,
    layer: *mut ViLayer,
) -> u32 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_vi_create_managed_layer(
    display: *const ViDisplay,
    _layer_flags: u32,
    aruid: u64,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_vi_destroy_managed_layer(layer: *mut ViLayer) -> u32 {
    if layer.is_null() {
        return GENERIC_ERROR;
    }
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_vi_close_layer(layer: *mut ViLayer) -> u32 {
    if layer.is_null() {
        return GENERIC_ERROR;
    }
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_vi_set_layer_size(
    layer: *const ViLayer,
    width: i32,
    height: i32,
) -> u32 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_vi_set_layer_z(layer: *const ViLayer, z: i32) -> u32 {
    if layer.is_null() {
        return GENERIC_ERROR;
    }
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_vi_set_layer_position(
    layer: *const ViLayer,
    x: f32,
    y: f32,
) -> u32 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_vi_set_layer_scaling_mode(
    layer: *const ViLayer,
    scaling_mode: u32,
) -> u32 {
    if layer.is_null() {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_vi_get_indirect_layer_image_map(
    buffer: *mut c_void,
    size: usize,
    width: i32,
    height: i32,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_vi_get_indirect_layer_image_required_memory_info(
    width: i32,
    height: i32,
    out_size: *mut u64,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_vi_set_content_visibility(visible: bool) -> u32 {
    let Some(service) = vi::get_service() else {
        return GENERIC_ERROR;
    };
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_vi_manager_prepare_fatal() -> u32 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_vi_manager_show_fatal() -> u32 {
    if let Some(rc) = require_fatal_display_supported() {
        return rc;
    }
    let Some(service) = vi::get_service() else {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_vi_manager_draw_fatal_rectangle(
    x: i32,
    y: i32,
    end_x: i32,
    end_y: i32,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_vi_manager_draw_fatal_text32(
    out_advance: *mut i32,
    x: i32,
    y: i32,
