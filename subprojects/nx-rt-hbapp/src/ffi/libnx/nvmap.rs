...
#[unsafe(no_mangle)]
pub extern "C" fn __nx_rt_hbapp__libnx_nvmap_init() -> u32 {
...
#[unsafe(no_mangle)]
pub extern "C" fn __nx_rt_hbapp__libnx_nvmap_exit() {
...
#[unsafe(no_mangle)]
pub extern "C" fn __nx_rt_hbapp__libnx_nvmap_get_fd() -> u32 {
...
/// process owns.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_nvmap_create(
    m: *mut NvMap,
    cpu_addr: *mut c_void,
    size: u32,
    align: u32,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_nvmap_load_remote(m: *mut NvMap, id: u32) -> u32 {
    let Some(record) = (unsafe { m.as_mut() }) else {
        return GENERIC_ERROR;
    };
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_nvmap_close(m: *mut NvMap) {
    let Some(record) = (unsafe { m.as_mut() }) else {
        return;
    };
    if !record.has_init {
