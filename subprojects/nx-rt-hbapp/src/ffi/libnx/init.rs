...
/// [`__nx_rt_hbapp__libnx_app_init`][super::app::__nx_rt_hbapp__libnx_app_init]:
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_init(
...
/// Closes what [`__nx_rt_hbapp__libnx_init`] opened and returns to the loader.
///
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_exit(status: i32) -> ! {
