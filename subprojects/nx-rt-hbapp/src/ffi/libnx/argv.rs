...
#[unsafe(no_mangle)]
pub static mut __nx_rt_hbapp__libnx_system_argc: i32 = 0;
...
#[unsafe(no_mangle)]
pub static mut __nx_rt_hbapp__libnx_system_argv: *mut *mut c_char =
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_argv_setup() {
...
pub(crate) unsafe fn publish(nxlink_host: Option<u32>) {
    if let Some((argc, argv)) = nx_sys_args::ffi::system_argv() {
        ...
        unsafe {
            __nx_rt_hbapp__libnx_system_argc = argc;
            __nx_rt_hbapp__libnx_system_argv = argv;
        }
    }
