...
#[unsafe(no_mangle)]
pub static mut __nx_rt_hbapp__libnx_nxlink_host: u32 = 0;
...
pub(crate) fn set_nxlink_host(addr: u32) {
    unsafe {
        __nx_rt_hbapp__libnx_nxlink_host = addr;
    }
}
...
#[unsafe(no_mangle)]
pub static mut __nx_rt_hbapp__libnx_applet_type: u32 = 0;
...
pub(crate) fn publish_applet_type() {
    ...
    unsafe { __nx_rt_hbapp__libnx_applet_type = env::applet_type().as_raw() as u32 };
}
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_env_setup(
