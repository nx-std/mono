...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_error_application_create(
...
/// by [`__nx_rt_hbapp__libnx_error_application_create`].
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_error_application_show(
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_error_result_show(
    _res: u32,
    _jump_flag: bool,
    _ctx: *const c_void,
) -> u32 {
...
/// `ctx` must be null or point to a readable `ErrorContext`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_error_code_show(
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_error_code_record_show(
    _error_code: ErrorCode,
    _timestamp: u64,
) -> u32 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_error_result_backtrace_create(
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_error_result_backtrace_show(
    _res: u32,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_error_system_create(
    _config: *mut c_void,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_error_system_show(_config: *mut c_void) -> u32 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_error_system_set_context(
    _config: *mut c_void,
    _ctx: *const c_void,
) {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_error_eula_show(_region_code: u32) -> u32 {
    todo!("errorEulaShow")
}
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_rt_hbapp__libnx_error_system_update_eula_show(
    _region_code: u32,
    _eula: *const c_void,
) -> u32 {
