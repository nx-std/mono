...
#[unsafe(no_mangle)]
pub extern "C" fn __nx_rt_hbapp__libnx_album_la_show_album_files() -> u32 {
...
/// user leaves the Album.
#[unsafe(no_mangle)]
pub extern "C" fn __nx_rt_hbapp__libnx_album_la_show_all_album_files() -> u32 {
...
#[unsafe(no_mangle)]
pub extern "C" fn __nx_rt_hbapp__libnx_album_la_show_all_album_files_for_home_menu() -> u32 {
