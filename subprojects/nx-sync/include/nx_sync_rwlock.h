 ...
 */
void __nx_sync_rwlock_init(RwLock* r);

/**
 * @brief Locks the read/write lock for reading.
 * @param r Read/write lock object.
 */
void __nx_sync_rwlock_read_lock(RwLock* r);
 ...
 */
bool __nx_sync_rwlock_try_read_lock(RwLock* r);

/**
 * @brief Unlocks the read/write lock for reading.
 * @param r Read/write lock object.
 */
void __nx_sync_rwlock_read_unlock(RwLock* r);

/**
 * @brief Locks the read/write lock for writing.
 * @param r Read/write lock object.
 */
void __nx_sync_rwlock_write_lock(RwLock* r);
 ...
 * @return 1 if the mutex has been acquired successfully, and 0 on contention.
 */
bool __nx_sync_rwlock_try_write_lock(RwLock* r);

/**
 * @brief Unlocks the read/write lock for writing.
 * @param r Read/write lock object.
 */
void __nx_sync_rwlock_write_unlock(RwLock* r);
 ...
 */
bool __nx_sync_rwlock_is_write_lock_held_by_current_thread(RwLock* r);
 ...
 */
bool __nx_sync_rwlock_is_owned_by_current_thread(RwLock* r);
