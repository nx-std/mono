...
//!
//! The main entry-point is [`dump_context`], which returns a [`Context`]
//! populated with the register state of the target thread.  The layout of
//! [`Context`], together with the [`CpuRegister`] and [`FpuRegister`]
...
//! [`crate::thread_pause::pause`]) to guarantee a consistent
//! snapshot.
...
/// [`crate::thread_pause::pause`]) otherwise the kernel will refuse the request
/// with an error.
