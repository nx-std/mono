...
impl PglService {
    ...
    /// Consumes and closes the PGL service session.
    #[inline]
    pub fn close(self) {
        self.0.close();
    }
...
impl PglService {
    ...
    pub fn launch_program_cmif(
        ...
        cmif::launch_program(self.0.session, loc, pm_launch_flags, pgl_launch_flags)
    }

    /// Terminates a process (cmd 1, CMIF).
    #[inline]
    pub fn terminate_process_cmif(&self, pid: u64) -> Result<(), DispatchCmifError> {
        cmif::terminate_process(self.0.session, pid)
    }
    ...
    pub fn launch_program_from_host_cmif(
        ...
        cmif::launch_program_from_host(self.0.session, content_path, pm_launch_flags)
    }
    ...
    pub fn enable_application_crash_report_cmif(
        ...
        cmif::enable_application_crash_report(self.0.session, enable)
    }
    ...
    pub fn is_application_crash_report_enabled_cmif(&self) -> Result<bool, DispatchCmifError> {
        cmif::is_application_crash_report_enabled(self.0.session)
    }
    ...
    pub fn enable_application_all_thread_dump_on_crash_cmif(
        ...
        cmif::enable_application_all_thread_dump_on_crash(self.0.session, enable)
    }
    ...
    pub fn trigger_application_snapshot_dumper(
        ...
        cmif::trigger_application_snapshot_dumper(self.0.session, dump_type, arg)
    }
    ...
    pub fn get_event_observer_cmif(&self) -> Result<PglEventObserver, GetEventObserverCmifError> {
        let service = cmif::get_event_observer(&self.0)?;
...
impl PglService {
    ...
    pub fn launch_program_tipc(
        ...
        tipc::launch_program(self.0.session, loc, pm_launch_flags, pgl_launch_flags)
    }

    /// Terminates a process (cmd 1, TIPC).
    #[inline]
    pub fn terminate_process_tipc(&self, pid: u64) -> Result<(), DispatchTipcError> {
        tipc::terminate_process(self.0.session, pid)
    }
    ...
    pub fn launch_program_from_host_tipc(
        ...
        tipc::launch_program_from_host(self.0.session, content_path, pm_launch_flags)
    }
    ...
    pub fn enable_application_crash_report_tipc(
        ...
        tipc::enable_application_crash_report(self.0.session, enable)
    }
    ...
    pub fn is_application_crash_report_enabled_tipc(&self) -> Result<bool, DispatchTipcError> {
        tipc::is_application_crash_report_enabled(self.0.session)
    }
    ...
    pub fn enable_application_all_thread_dump_on_crash_tipc(
        ...
        tipc::enable_application_all_thread_dump_on_crash(self.0.session, enable)
    }
    ...
    pub fn get_event_observer_tipc(&self) -> Result<PglEventObserver, GetEventObserverTipcError> {
        let service = tipc::get_event_observer(&self.0)?;
        Ok(PglEventObserver(service))
    }
}
...
/// monitoring.
pub struct PglEventObserver(Service);
...
impl PglEventObserver {
    ...
    /// Consumes and closes the event observer session.
    #[inline]
    pub fn close(self) {
        self.0.close();
    }
